...
//             ))}
//             {cartItems.length === 0 && (
//               <div className="flex gap-5  flex-col justify-center items-center text-center w-[500px] h-[500px]">
//                 <div className="flex justify-center items-center text-center   gap-3">
//                   <p className=" text-3xl ">Why your cart so empty?</p>
//                   <CgSmileSad className="h-[200px] w-[200px]" />
//                 </div>
//                 <button
//                   className="bg-darkBrand p-2  text-2xl text-white rounded-lg"
...
//             <div className="flex flex-col gap-5">
//               <h1 className="text-black  text-4xl font-bold"> Checkout </h1>
//               <p className="text-darkBrand text-xl">
